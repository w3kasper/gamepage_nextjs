...
const Download = () => {
  return (
    <div className="bg-neutral-800 border border-purple-500 rounded-lg p-3 pt-4">
      ...
      <div className="flex items-center space-x-3 rounded-full bg-neutral-900 p-2 pl-[15px]">
        {" "}
